...
public class TestJohnsonMotor extends SubsystemBase {
  ...
  // public PIDController m_PID = new PIDController(JohnsonMotorConstants.kP,
  // JohnsonMotorConstants.kI,
  ...
  public TestJohnsonMotor() {
    ...
    // m_JohnsonMotor.set(m_PID.calculate(m_JohnsonEncoder.getDistance(),
    // Constants.JohnsonMotorConstants.kSetPoint));
    ...
    // m_PID.calculate(m_JohnsonEncoder.getDistance(),
    // Constants.JohnsonMotorConstants.kSetPoint));
  ...
  // m_PID.setIntegratorRange(Constants.JohnsonMotorConstants.kMIN_OUTPUT,
  // Constants.JohnsonMotorConstants.kMAX_OUTPUT);
  // }
